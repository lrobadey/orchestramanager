...
This roadmap breaks **Orchestra Manager** into small, nested milestones.

The goal is not to scaffold the entire game at once. Each milestone should add one durable layer to the simulation while preserving a complete playable loop.
